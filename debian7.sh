...
# set repo
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/Office48/VPSScript/master/conf/sources.list.debian7"
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/Office48/VPSScript/master/conf/squid3.conf"
...
# info
clear
echo "UPILServer.co.vu | @Office48 | Office48 | 03" | tee log-install.txt
